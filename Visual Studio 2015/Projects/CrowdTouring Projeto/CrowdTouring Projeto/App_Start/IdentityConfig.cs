...
namespace CrowdTouring_Projeto
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            MailMessage email = new MailMessage(new MailAddress("CrowdTouring@gmail.com", "CrowdTouring@gmail.com"),
            ...
            using (var mailClient = new CrowdTouring_Projeto.Models.GmailEmailService())
            {
